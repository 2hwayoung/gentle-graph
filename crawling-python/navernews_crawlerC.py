...
def crawling(chrome_driver_path: str):
    ...
    press_link = [('ZDNet Korea', '/main/ranking/office.nhn?officeId=092'), ('한국경제TV', '/main/ranking/office.nhn?officeId=215'), ('신동아', '/main/ranking/office.nhn?officeId=262'), ('문화일보', '/main/ranking/office.nhn?officeId=021'), ('이코노미스트', '/main/ranking/office.nhn?officeId=243'), ('국민일보', '/main/ranking/office.nhn?officeId=005'), ('월간 산', '/main/ranking/office.nhn?officeId=094'), ('코리아중앙데일리', '/main/ranking/office.nhn?officeId=640'), ('매일경제', '/main/ranking/office.nhn?officeId=009'), ('헬스조선', '/main/ranking/office.nhn?officeId=346'), ('경향신문', '/main/ranking/office.nhn?officeId=032'), ('아시아경제', '/main/ranking/office.nhn?officeId=277'), ('부산일보', '/main/ranking/office.nhn?officeId=082'), ('동아사이언스', '/main/ranking/office.nhn?officeId=584'), ('연합뉴스', '/main/ranking/office.nhn?officeId=001'), ('전자신문', '/main/ranking/office.nhn?officeId=030'), ('블로터', '/main/ranking/office.nhn?officeId=293'), ('중앙일보', '/main/ranking/office.nhn?officeId=025'), ('조선일보', '/main/ranking/office.nhn?officeId=023'), ('동아일보', '/main/ranking/office.nhn?officeId=020'), ('조세일보', '/main/ranking/office.nhn?officeId=123'), ('디지털타임스', '/main/ranking/office.nhn?officeId=029'), ('주간경향', '/main/ranking/office.nhn?officeId=033'), ('시사IN', '/main/ranking/office.nhn?officeId=308'), ('비즈니스워치', '/main/ranking/office.nhn?officeId=648')]
    news_info = []
...
if __name__ == "__main__":
    ...
    out_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), f'data/naver_data_C_{time_str}.json') 
