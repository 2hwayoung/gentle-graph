...
def crawl_detail_content(driver, data: dict, producer) -> dict:
    ...
    time.sleep(1)
    menu_container = driver.find_element_by_css_selector("#menu-container")

    try:
        good = (
            driver.find_element_by_xpath("/html/body/ytd-app/div/ytd-page-manager/ytd-watch-flexy/div[5]/div[1]/div/div[6]/div[2]/ytd-video-primary-info-renderer/div/div/div[3]/div/ytd-menu-renderer/div[2]/ytd-toggle-button-renderer[1]/a/yt-formatted-string")
            .text
        )
    except:
        good = 0
    ...
    try:
        bad = (
            driver.find_element_by_xpath("/html/body/ytd-app/div/ytd-page-manager/ytd-watch-flexy/div[5]/div[1]/div/div[6]/div[2]/ytd-video-primary-info-renderer/div/div/div[3]/div/ytd-menu-renderer/div[2]/ytd-toggle-button-renderer[2]/a/yt-formatted-string")
            .text
        )
    except:
        bad = 0
    ...
    data.update(
        {
            ...
            "n_reactions": str_to_int(good)+str_to_int(bad),
            "n_comment": comments,
            "hashtags": hashtags,
