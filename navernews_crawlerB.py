...
def crawling(chrome_driver_path: str):
    ...
    press_link = [('채널A', '/main/ranking/office.nhn?officeId=449'), ('더팩트', '/main/ranking/office.nhn?officeId=629'), ('매경이코노미', '/main/ranking/office.nhn?officeId=024'), ('매일신문', '/main/ranking/office.nhn?officeId=088'), ('서울경제', '/main/ranking/office.nhn?officeId=011'), ('주간조선', '/main/ranking/office.nhn?officeId=053'), ('여성신문', '/main/ranking/office.nhn?officeId=310'), ('뉴시스', '/main/ranking/office.nhn?officeId=003'), ('서울신문', '/main/ranking/office.nhn?officeId=081'), ('일다', '/main/ranking/office.nhn?officeId=007'), ('MBN', '/main/ranking/office.nhn?officeId=057'), ('코리아헤럴드', '/main/ranking/office.nhn?officeId=044'), ('오마이뉴스', '/main/ranking/office.nhn?officeId=047'), ('시사저널', '/main/ranking/office.nhn?officeId=586'), ('세계일보', '/main/ranking/office.nhn?officeId=022'), ('한경비즈니스', '/main/ranking/office.nhn?officeId=050'), ('주간동아', '/main/ranking/office.nhn?officeId=037'), ('헤럴드경제', '/main/ranking/office.nhn?officeId=016'), ('데일리안', '/main/ranking/office.nhn?officeId=119'), ('프레시안', '/main/ranking/office.nhn?officeId=002'), ('MBC', '/main/ranking/office.nhn?officeId=214'), ('연합뉴스TV', '/main/ranking/office.nhn?officeId=422'), ('머니투데이', '/main/ranking/office.nhn?officeId=008'), ('중앙SUNDAY', '/main/ranking/office.nhn?officeId=353')]
    news_info = []
...
if __name__ == "__main__":
    ...
    out_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), f'data/naver_data_B_{time_str}.json') 
